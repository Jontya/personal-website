        ...
        <div className='resume'>
            ...
            <IconContext.Provider value ={{size: "1.2em", }}>
                ...
                <ul className='resume-contacts'>
                    <li><a href="mailto:jontyatkinson2002@gmail.com" className='hover-animation'>
                        <FaEnvelope className='icon'/> 
                        <span className='icon-spacing'>Email</span></a>
                    </li>
                    <li><a href="https://www.linkedin.com/in/jonty-atkinson/" className='hover-animation'>
                        <FaLinkedin className='icon'/> 
                        <span className='icon-spacing'>LinkedIn</span></a>
                    </li>
                    <li><a href="https://github.com/Jontya" className='hover-animation'>
            ...
            <div className='resume-projects'>
                ...
                <ul className='resume-projects-list'>
                    <li className='resume-list-title'>Production Line Discrete Event Simulator 
                        <span className='resume-list-subtitle'>| Java, GitHub</span> <span className='resume-list-sidebar'>May 2022</span>
                    </li>
                    ...
                    <li className='resume-list-title'>Sorting Algorithm Visualizer 
                        <span className='resume-list-subtitle'>| React, GitHub</span> 
                        <span className='resume-list-sidebar'>June 2022</span>
                    </li>
                    <ul className='resume-list-sublist'>
                    ...
                    <li className='resume-list-title'>Personal Portfolio 
                        <span className='resume-list-subtitle'>| React, GitHub</span> 
                        <span className='resume-list-sidebar'>July 2022</span> 
                    </li>
                    <ul className='resume-list-sublist'>
                    ...
                    <li className='resume-list-title'>Scheduling Algorithm Simulator 
                        <span className='resume-list-subtitle'>| Java, GitHub</span> 
                        <span className='resume-list-sidebar'>August 2022</span>
                    </li>
                    <ul className='resume-list-sublist'>
